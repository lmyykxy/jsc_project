...
// 写FIFO
    ...
    output  wire    [31:0]  ov5640_data_out     //图像数据~~~~~~~~改为24位RGB输出并补0到32位
);
...
//ov5640_data_out:输出16位图像数据~~~~~~~~~32
assign  ov5640_data_out = (pic_valid == 1'b1) ? ({8'd0, data_out_reg[15:11] , 3'd0 , data_out_reg[10:5], 2'd0 , data_out_reg[4:0], 3'd0} ) : 32'b0;
